        ...
        <div className="max-w-[1400px] mx-auto px-3 sm:px-6 lg:px-8 flex justify-between items-center gap-2 sm:gap-4 py-1.5 sm:py-2 overflow-visible">
          ...
          <div className="flex items-center gap-2 sm:gap-3 z-[1002]">
            ...
            <motion.a
              ...
              className="hidden md:flex items-center gap-2 px-5 lg:px-6 py-2.5 lg:py-3 text-sm lg:text-base font-bold bg-secondary text-white rounded-full transition-all duration-300 hover:bg-secondary-dark hover:shadow-[0_0_20px_rgba(34,197,94,0.5)]"
            >
            ...
            <motion.button
              ...
              className="hidden md:flex flex-col items-center px-6 lg:px-8 py-2.5 lg:py-3 text-sm lg:text-base font-bold bg-primary text-white rounded-full transition-all duration-300 hover:bg-primary-dark hover:shadow-[0_0_20px_rgba(220,38,38,0.5)] premium-order-button"
            >
              <span>Order Now</span>
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              href="tel:+14072032499"
              className="md:hidden flex items-center gap-1.5 px-3 sm:px-4 py-2 text-xs sm:text-sm font-bold bg-secondary text-white rounded-full transition-all duration-300 hover:bg-secondary-dark hover:shadow-[0_0_15px_rgba(34,197,94,0.4)]"
              onClick={closeNavbar}
            >
            ...
            <motion.button
              ...
              className="md:hidden flex items-center gap-1.5 px-3 sm:px-4 py-2 text-xs sm:text-sm font-bold bg-primary text-white rounded-full transition-all duration-300 hover:bg-primary-dark hover:shadow-[0_0_15px_rgba(220,38,38,0.4)] premium-order-button"
            >
