...
export default function SplashAnimation() {
  ...
  useEffect(() => {
    ...
    if (!hasPlayedInSession) {
      ...
      const timer = setTimeout(() => setShowSplash(false), 4500); // 4.5 second total
    ...
    <AnimatePresence>
      {showSplash && (
        <motion.div
          ...
          className="fixed inset-0 z-[9999] flex flex-col items-center justify-center overflow-hidden bg-neutral-950"
        >
