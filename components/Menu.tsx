      ...
      <div className="max-w-[1400px] mx-auto px-3 sm:px-4 lg:px-8">
        ...
        <div className="flex-1 min-h-[500px] relative">
          <div className="w-full">
            ...
            <ul className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 lg:gap-6">
              {currentCategory.items.map((item, index) => (
                ...
                >
                  ...
                  >
                    <figure
                      className="w-full aspect-square relative overflow-hidden bg-neutral-200/60"
                      style={{
