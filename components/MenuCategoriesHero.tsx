      ...
      <div className="max-w-[1400px] mx-auto px-1 sm:px-2 lg:px-3">
        <div className="mb-0 relative rounded-3xl sm:rounded-[2rem] lg:rounded-[2.5rem] p-2 sm:p-4 lg:p-6 pb-6 sm:pb-8 lg:pb-10 shadow-[0_20px_60px_rgba(0,0,0,0.8),0_0_0_3px_rgba(255,255,255,0.1),inset_0_1px_0_rgba(255,255,255,0.15),inset_0_-1px_0_rgba(0,0,0,0.5)] transform perspective-1000 overflow-hidden" style={{
          ...
          <motion.h2 
            ...
            className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-display font-black text-white text-center mb-6 sm:mb-8 leading-tight"
          >
            ...
            {menuCategories.map((category, index) => (
              ...
              >
                <Link
                  ...
                  className="group flex flex-col items-center justify-center bg-transparent p-2 sm:p-3 lg:p-4 transition-all duration-300"
                  prefetch={false}
                >
                  <motion.div 
                    whileHover={{ scale: 1.1 }}
                    whileTap={{ scale: 0.95 }}
                    className="w-full flex items-center justify-center mb-2 sm:mb-3"
                  >
                    <div className="relative w-32 h-32 sm:w-36 sm:h-36 md:w-40 md:h-40 lg:w-44 lg:h-44 transition-transform duration-300">
                      <Image
                        src={category.icon}
                        width={280}
                        height={280}
