...
export const menuItemDetails: MenuItemDetail[] = [
  ...
  },
  {
    ...
    tags: ['Grilled', 'Non-Vegetarian'],
    dietaryInfo: ['Contains Dairy'],
    chefNotes: 'Served with mint chutney and lemon wedges.',
    perfectFor: 'When you want something smoky and protein-packed.',
  },
  {
    id: 'chicken-65',
    name: 'Chicken 65',
  ...
  },
  {
    ...
    tags: ['Premium', 'Rich'],
    dietaryInfo: ['Contains Dairy'],
    chefNotes: 'A premium, indulgent curry for lamb lovers.',
    perfectFor: 'Special occasions and serious cravings.',
  },
  {
    id: 'chicken-saag',
